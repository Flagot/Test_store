...
from scr.pages.locators.components.NotificationBarLocators import NotificationBarLocators
...
class NotificationBar(NotificationBarLocators):
    ...
    def verify_notification_bar_is_not_displayed(self):
        ...
        # we know the notification bar has setting to shows up after a delay.
