...
from scr.SeleniumExtended import SeleniumExtended
from scr.pages.locators.CheckoutPageLocators import CheckoutPageLocators
from scr.helpers.generic_helpers import generate_random_email_and_password
from scr.helpers.config_helpers import get_base_url
